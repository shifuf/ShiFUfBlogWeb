    ...
    <div class="box_card">
      <div class="content">
        <div class="list" v-if="paramsId">
              ...
              <div class="article-meta">
                <div class="tags">
                  <span v-for="tags in item.tag">
                    <RouterLink :to="'/category/' + tags.id"
          ...
          <a-empty style="margin: 0 auto;" v-if="articleList.length == 0" :description="'暂无数据'"/>
        </div>
...
import { getCategoryList, getCategoryArticle } from "@/api/Category";
